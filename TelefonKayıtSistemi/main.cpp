...
int main () {
	...
	do
	{
			...
			for (int i = 0; i < kisiSayisi; i++) {
				...
				for (int j = 0; j < kisiSayisi; j++) {
					...
					if (abs (top - top2) % 32 == 0) {
						...
						cout << "Is Telefonu:" << tel[j].getÝsTel () << endl;
						cout << "************" << endl;
						cout << endl;
		...
		case '3': {aramaM:
			...
			IDAM:
				...
				for (i = 0; i < kisiSayisi; i++) {
					if (aranacakID == tel[i].getID ()) {
						...
						cout << "Is Telefonu:" << tel[i].getÝsTel () << endl;
						cout << "\n\nAranan kisi bulundu.";
			...
			int i;
			for (i = 0; i < kisiSayisi; i++) {
				if (aranacakIsTel == tel[i].getÝsTel ()) {
					cout << "ID:" << tel[i].getID () << endl;
					cout << "Isim:" << tel[i].getAd () << endl;
					cout << "Soyisim:" << tel[i].getSoyad () << endl;
					cout << "Cep Telefonu:" << tel[i].getCepTel () << endl;
			...
			hata5:
				int i1;
				cout << "\aAranan is telefonu bulunamadi" << endl << "1.Ana menuye geri donun" << endl << "2.Arama menusune geri donun" << endl << "3.Ýs telefonu arama menusune geri donun" << endl << "4.Cikis" << endl;
				cin >> i1;
				if (i1 == 1) {
					break;
				}
		...
		if (dosya.is_open ()) {
			for (int i = 0; i < kisiSayisi; i++) {
				...
				dosya << "Is Telefonu:" << tel[i].getÝsTel () << endl;
				dosya << "********" << endl;
			}
		}
		else
